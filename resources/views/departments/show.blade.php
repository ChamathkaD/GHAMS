        ...
        <div class="col-8 mt-5" style="margin-left: 180px">
            <div class="card card-widget">
                <div class="card-header">
                    <h2 class="mt-4 text-primary">{{ $department->department_code}}<span class="pull-right">
 ...
 <a href="{{ route('department.edit',$department->id) }}" class="btn mb-1 btn-primary">Edit</a>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mt-4">
                                ...
                                <h6 class="m-t-10 text-muted">{{ $department->department_code}}</h6>
                        ...
                        <div class="col-md-6">
                            <div class="mt-4">
                                <h4>Description</h4>
                                <h6 class="m-t-10 text-muted">{{ $department->description}} </h6>
                    ...
                    <div class="mt-5 pull-right text-primary">
                        <small>
                            Registered At:{{ $department->created_at }}
                        </small>
                        <small class="ml-3">
                            Last Update:{{ $department->updated_at }}
