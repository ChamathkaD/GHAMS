...
@section('content')
    ...
    <div class="content-body">
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title"> Crate hospital</h4>
...
Fax"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('hospital_code_prefix') }}"
                                    >
                            ...
                            <button type="submit" class="btn btn-dark">Create Hospital</button>
                        </form>
                    </div>
                </div>
            </div>
